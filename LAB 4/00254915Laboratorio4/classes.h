...
enum parameters {ELEMENT_LENGTH,VARIABLE_T,VARIABLE_K,VARIABLE_LAMBDA,VARIABLE_U,VARIABLE_W,VARIABLE_ALPHA,VARIABLE_S,VARIABLE_N};
...
class mesh{
    ...
    public:
        void setParameters(float l,float T,float K,float LAMBDA,float U,float W,float ALFA,float S,float N){
            ...
            parameters[VARIABLE_LAMBDA]=LAMBDA;
            parameters[VARIABLE_U]=U;
            parameters[VARIABLE_W]=W;
            parameters[VARIABLE_ALPHA]=ALFA;
            parameters[VARIABLE_S]=S;
